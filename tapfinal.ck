//tapfinal.ck
//Noah Brackenbury, Spring 2016, MUSC 208
...
while( cont == 0 )
{
    ...
    while( min.recv(mmsg) )
    {
        // print out midi message and continue
...
while( prep == 0 )
{
    ...
    while( min.recv(mmsg) )
    {
        // print out midi message and clear pedal
        <<< mmsg.data1, mmsg.data2, mmsg.data3 >>>;
        if(mmsg.data1 == 176 && mmsg.data3 == 127){1 +=> prep;}
    }
}
...
while( ending == 0 )
{
    ...
    while( min.recv(mmsg) )
    {
        // print out midi message and play final note
        <<< mmsg.data1, mmsg.data2, mmsg.data3 >>>;
        if(mmsg.data1 == 176 && mmsg.data3 == 0){3 => s5.noteOn;}
        if(mmsg.data1 == 176 && mmsg.data3 == 127){1 +=> ending;}
    }
}
3 => s5.noteOff;
ei * 16 => now;